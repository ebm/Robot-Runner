...
import com.robotrunner.Entities.MonsterPackage.Golem;
import com.robotrunner.Entities.MonsterPackage.Spaceship;
import com.robotrunner.Entities.PlayerPackage.Player;
import com.robotrunner.Items.Armor;
import com.robotrunner.Items.Boots;
import com.robotrunner.Items.Dash;
import com.robotrunner.Items.Heart;
import com.robotrunner.States.MyGame;
import com.robotrunner.Weapons.Laser;
...
public class Map {
    ...
    public float format(float val) {
        return ((float) ((int) (val * 100)) / 100f);
    }
    private void addEdgeToList(Edge edge, ArrayList<Edge> edgeList) {
        edge.a.x = format(edge.a.x);
        edge.a.y = format(edge.a.y);

        edge.b.x = format(edge.b.x);
        edge.b.y = format(edge.b.y);
